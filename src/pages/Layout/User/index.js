...
export default function User() {
  ...
  // build initial userData from cookies (if you manually set them while BE missing)
  ...
  // start with cookie fallback (shows immediately) but will be overwritten when API responds
